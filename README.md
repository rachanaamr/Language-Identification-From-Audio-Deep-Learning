...
Baseline Model - train_model_facebook_baseline.ipynb <br>
Improved Baseline - train_model_HuBert_improved.ipynb <br>
DANN Architecture - train_model_Dann.ipynb <br>
...
1.⁠ ⁠Import the code in Kaggle as a new notebook. <br>
...
Run the cells sequentially. The first cell handles all dependency installations and downgrades datasets to ensure compatibility:<br>
!pip install evaluate transformers accelerate <br>
!pip install datasets==3.6.0 <br>
